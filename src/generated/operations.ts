...
export const OPERATIONS: readonly Operation[] = [
		...
		queryParams: [
			{
				name: "resourceId",
				description:
					"Vanta generated identifier for the given resource, and can be found on the developer console page. See the list of regis",
				type: "string",
			},
		],
	},
	{
		...
		body: {
			required: true,
			properties: ["resourceId", "resources"],
			requiredProperties: ["resourceId", "resources"],
		},
	},
	{
		id: "CreateAuditor",
		...
		body: {
			required: true,
			properties: ["email", "givenName", "familyName"],
			requiredProperties: ["email", "givenName", "familyName"],
		},
	},
	{
		...
		risk: "write",
		pathParams: ["auditId", "requestId"],
		queryParams: [],
		body: {
			required: true,
			properties: ["auditorEmail"],
			requiredProperties: ["auditorEmail"],
		},
	},
	{
		...
		risk: "write",
		pathParams: ["auditId", "auditEvidenceId"],
		queryParams: [],
		body: {
			required: true,
			properties: ["text", "email", "creationDate"],
			requiredProperties: ["text", "email", "creationDate"],
		},
	},
	{
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["externalId", "name", "description", "effectiveDate", "category", "sections", "role"],
			requiredProperties: ["externalId", "name", "description", "effectiveDate", "category"],
		},
	},
	{
		...
		body: {
			required: true,
			properties: ["controlIds", "title", "description", "cadence", "reminderWindow", "isRestricted", "auditorEmail"],
			requiredProperties: [
				"controlIds",
				"title",
				"description",
	...
	},
	{
		...
		body: {
			...
			requiredProperties: ["uniqueId", "title", "requestType", "frameworkCodes"],
		},
	},
	{
		...
		risk: "destructive",
		pathParams: ["auditId", "controlId", "commentId"],
		queryParams: [],
		body: {
			required: true,
			properties: ["email"],
	...
	},
	{
		...
		risk: "destructive",
		pathParams: ["auditId", "requestId", "commentId"],
		queryParams: [],
		body: {
			required: true,
			properties: ["email"],
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["auditorEmail", "reason"],
			requiredProperties: ["auditorEmail", "reason"],
		},
	},
	{
		id: "GetAudit",
	...
	},
	{
		...
		risk: "read",
		pathParams: ["auditId", "auditEvidenceId", "commentId"],
		queryParams: [],
	},
	{
	...
	},
	{
		...
		risk: "read",
		pathParams: ["auditId", "requestId", "evidenceId"],
		queryParams: [],
	},
	{
	...
	},
	{
		...
		queryParams: [
			...
			},
			{
				name: "assetType",
				description:
					"Filter vulnerable assets by asset type. Possible values: CODE_REPOSITORY, CONTAINER_REPOSITORY, CONTAINER_REPOSITORY_IMA",
				type: "string",
			},
			{
	...
	},
	{
		...
		queryParams: [
			...
			},
			{
				name: "orderBy",
				description:
					'Field to sort results by. Allowed: "riskId", "riskScenario", "inherentRisk", "treatment", "residualRisk", "reviewStatus"',
				type: "string",
			},
			{
				name: "orderDirection",
	...
	},
	{
		...
		queryParams: [
			...
			},
			{
				name: "changedSinceDate",
				description:
					"Includes all comments that have changed since changedSinceDate. Considers creationDate, modificationDate, and deletionDa",
				type: "string",
			},
		],
	},
	...
	},
	{
		...
		queryParams: [
			...
			},
			{
				name: "changedSinceDate",
				description:
					"Includes all evidence that have changed since changedSinceDate. Considers creationDate, modificationDate, deletionDate, ",
				type: "string",
			},
			{
				name: "evidenceTypeMatchesAny",
				description:
					"Limits results to the provided evidence types. Must include at least one of: UPLOADED_DOCUMENT, OBSERVATION, LINK, VANTA",
				type: "array",
			},
		],
	},
	{
		...
		queryParams: [
			...
			},
			{
				name: "changedSinceDate",
				description:
					"Includes all information requests that have changed since changedSinceDate. Considers creationDate, modificationDate, an",
				type: "string",
			},
			{
				name: "segmentIdsMatchesAny",
				description:
					"Return requests whose stored segment assignment includes any of these IDs (OR). Omit to return all. A match can still co",
				type: "array",
			},
		],
	},
	...
	},
	{
		...
		queryParams: [
			...
			},
			{
				...
				description:
					"Requires taskStatusMatchesAny. Includes all people for whom any of the provided taskType values in taskTypeMatchesAny is",
				type: "array",
			},
			{
				name: "taskStatusMatchesAny",
				description:
					"Requires taskTypeMatchesAny. Includes all people for whom any of the provided taskType values in taskTypeMatchesAny is a",
				type: "array",
			},
		],
		deprecated: true,
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["segmentId", "assessmentState", "justification", "auditorEmail"],
			requiredProperties: ["assessmentState", "justification", "auditorEmail"],
		},
	},
	{
	...
	},
	{
		...
		risk: "write",
		pathParams: ["controlId"],
		queryParams: [],
		body: {
			required: true,
			properties: ["documentId"],
			requiredProperties: ["documentId"],
		},
	},
	{
		id: "AddTestToControl",
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["externalId", "name", "description", "effectiveDate", "domain", "sections", "role", "customFields"],
			requiredProperties: ["externalId", "name", "description", "effectiveDate", "domain"],
		},
	},
	{
		id: "DeleteControl",
	...
	},
	{
		...
		risk: "destructive",
		pathParams: ["controlId", "documentId"],
		queryParams: [],
	},
	{
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["name", "externalId", "description", "domain", "note", "customFields"],
			requiredProperties: [],
		},
	},
	{
	...
	},
	{
		...
		risk: "write",
		pathParams: ["tagCategoryId"],
		queryParams: [],
		body: {
			required: true,
			properties: ["productContextId"],
			requiredProperties: ["productContextId"],
		},
	},
	{
		...
		body: {
			required: true,
			properties: ["statusChangeMessage"],
			requiredProperties: [],
		},
	},
	{
		...
		body: {
			required: true,
			properties: ["shouldSyncApprovedToAnswerLibrary"],
			requiredProperties: [],
		},
	},
	{
		...
		body: {
			required: true,
			properties: ["name", "emailDomain", "ndaDetails", "accessConfig", "customFields", "tagsByCategory"],
			requiredProperties: ["name", "emailDomain"],
		},
	},
	{
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["questionnaireId", "format"],
			requiredProperties: ["questionnaireId", "format"],
		},
	},
	{
		...
		body: {
			...
			requiredProperties: ["displayName", "url"],
		},
	},
	{
	...
	},
	{
		...
		risk: "read",
		pathParams: ["questionnaireId", "responseId"],
		queryParams: [],
	},
	{
	...
	},
	{
		...
		risk: "destructive",
		pathParams: ["tagCategoryId", "productContextId"],
		queryParams: [],
	},
	{
		...
		body: {
			required: true,
			properties: ["name", "emailDomain", "customFields", "tagsByCategory"],
			requiredProperties: [],
		},
	},
	{
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["answerPartsValues"],
			requiredProperties: ["answerPartsValues"],
		},
	},
	{
		...
		body: {
			required: true,
			properties: ["ownerAssignment"],
			requiredProperties: ["ownerAssignment"],
		},
	},
	{
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["title", "description", "timeSensitivity", "cadence", "reminderWindow", "isSensitive"],
			requiredProperties: ["title", "description", "timeSensitivity", "cadence", "reminderWindow", "isSensitive"],
		},
	},
	{
		...
		body: {
			required: true,
			properties: ["url", "title", "description", "effectiveDate"],
			requiredProperties: ["url", "title"],
		},
	},
	{
		id: "DeleteDocument",
	...
	},
	{
		...
		risk: "destructive",
		pathParams: ["documentId", "uploadedFileId"],
		queryParams: [],
	},
	{
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["pointOfContactEmail", "description", "name"],
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["idpGroupIds"],
			requiredProperties: ["idpGroupIds"],
		},
	},
	{
	...
	},
	{
		...
		risk: "read",
		pathParams: ["integrationId", "resourceKind", "resourceId"],
		queryParams: [],
	},
	{
		...
		risk: "read",
		pathParams: ["integrationId", "resourceKind"],
		queryParams: [
			{
				name: "connectionId",
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["inScope", "description", "ownerId"],
			requiredProperties: [],
		},
	},
	{
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["question", "answer", "ownerAssignment", "expirationDate", "tags"],
	...
	},
	{
		...
		queryParams: [
			...
			},
			{
				name: "matchesTags",
				description:
					"JSON-encoded array of `{categoryId, tagId}` pairs. Entries matching any of the given tags are returned (OR filter). Disc",
				type: "string",
			},
			{
				name: "expiresBefore",
	...
	},
	{
		...
		queryParams: [
			...
			},
			{
				name: "matchesTags",
				description:
					"JSON-encoded array of `{categoryId, tagId}` pairs. Tags within the same category are OR'd together; tags across differen",
				type: "string",
			},
			{
				name: "expiresBefore",
	...
	},
	{
		...
		body: {
			...
			requiredProperties: ["endDate", "startDate"],
		},
	},
	{
		id: "UpdatePerson",
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["controlId", "controlType"],
			requiredProperties: ["controlId"],
		},
	},
	{
		...
		risk: "destructive",
		pathParams: ["riskScenarioId", "controlId"],
		queryParams: [],
	},
	{
		id: "GetRiskScenario",
	...
	},
	{
		...
		queryParams: [
			...
			},
			{
				name: "type",
				description:
					'Filter by risk scenario type. Defaults to "Risk Scenario". Only returns enterprise risks when explicitly set to "Enterpr',
				type: "string",
			},
			{
				name: "orderBy",
	...
	},
	{
		...
		body: {
			...
			requiredProperties: ["controlType"],
		},
	},
	{
		id: "get-Secret",
	...
	},
	{
		...
		risk: "destructive",
		pathParams: ["testId", "entityId"],
		queryParams: [],
		body: {
			required: true,
			properties: ["deactivateReason", "deactivateUntilDate"],
			requiredProperties: ["deactivateReason"],
		},
	},
	{
		id: "GetTest",
	...
	},
	{
		...
		queryParams: [
			...
			},
			{
				name: "statusFilter",
				description:
					"Filter tests by test status. Possible values: OK (Test passed), DEACTIVATED (Test is deactivated), NEEDS_ATTENTION (Test",
				type: "string",
			},
			{
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["controlId", "categoryIds"],
			requiredProperties: ["controlId", "categoryIds"],
		},
	},
	{
	...
	},
	{
		...
		body: {
			...
			requiredProperties: ["email", "name", "companyName", "isNdaRequired", "accessLevel"],
		},
	},
	{
		...
		risk: "write",
		pathParams: ["slugId", "accessRequestId"],
		queryParams: [],
		body: {
			required: true,
			properties: ["expirationDate", "isNdaRequired", "resourceIds", "accessLevel"],
			requiredProperties: [],
		},
	},
	{
		...
		body: {
			required: true,
			properties: ["controlIds", "tagCategory", "tags"],
			requiredProperties: ["controlIds", "tagCategory", "tags"],
		},
	},
	{
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["name", "standard", "description"],
			requiredProperties: ["name"],
		},
	},
	{
		...
		body: {
			required: true,
			properties: ["question", "answer", "categoryId"],
			requiredProperties: ["question", "answer"],
		},
	},
	{
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["name", "url", "description", "location", "purpose"],
			requiredProperties: ["name"],
		},
	},
	{
		...
		body: {
			required: true,
			properties: ["email", "customerTrustAccountId", "shouldSkipEmailVerification"],
			requiredProperties: ["email"],
		},
	},
	{
		...
		body: {
			required: true,
			properties: ["name", "subscriberIds"],
			requiredProperties: ["name", "subscriberIds"],
		},
	},
	{
		...
		body: {
			...
			requiredProperties: ["title", "description", "category"],
		},
	},
	{
	...
	},
	{
		...
		risk: "destructive",
		pathParams: ["slugId", "subprocessorId"],
		queryParams: [],
	},
	{
		...
		risk: "destructive",
		pathParams: ["slugId", "subscriberId"],
		queryParams: [],
	},
	{
		...
		risk: "destructive",
		pathParams: ["slugId", "subscriberGroupId"],
		queryParams: [],
	},
	{
	...
	},
	{
		...
		risk: "read",
		pathParams: ["slugId", "conversationId"],
		queryParams: [],
	},
	{
		id: "GetTrustCenter",
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["emails", "subscriberGroupIds", "customerTrustAccounts"],
			requiredProperties: ["emails", "subscriberGroupIds"],
		},
	},
	{
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["name", "visibility", "statusVisibilityOverride"],
			requiredProperties: [],
		},
	},
	{
		...
		body: {
			required: true,
			properties: ["controlsToAdd", "controlsToRemove"],
			requiredProperties: ["controlsToAdd", "controlsToRemove"],
		},
	},
	{
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["title", "isPublic", "description"],
			requiredProperties: [],
		},
	},
	{
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["description", "location", "purpose"],
			requiredProperties: [],
		},
	},
	{
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["title", "description", "category", "visibilityType"],
			requiredProperties: ["title", "description", "category"],
		},
	},
	{
		...
		body: {
			required: true,
			properties: ["accessLevel", "resourceIds", "expirationDate", "isNdaRequired", "customerTrustAccountId"],
			requiredProperties: [],
		},
	},
	{
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["orderedCategoryIds"],
			requiredProperties: ["orderedCategoryIds"],
		},
	},
	{
		...
		body: {
			required: true,
			properties: ["orderedControlIds"],
			requiredProperties: ["orderedControlIds"],
		},
	},
	{
		...
		body: {
			required: true,
			properties: ["dataCollected", "dataCollectedHeading"],
			requiredProperties: ["dataCollected"],
		},
	},
	{
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["content", "riskStatus", "remediation", "securityReviewId", "documentId"],
			requiredProperties: ["content", "riskStatus"],
		},
	},
	{
		id: "DeleteById",
	...
	},
	{
		...
		risk: "destructive",
		pathParams: ["vendorId", "securityReviewId", "documentId"],
		queryParams: [],
	},
	{
		...
		risk: "read",
		pathParams: ["vendorId", "assessmentId"],
		queryParams: [],
	},
	{
	...
	},
	{
		...
		risk: "read",
		pathParams: ["vendorId", "securityReviewId"],
		queryParams: [
			{
				name: "pageSize",
				description: "",
	...
	},
	{
		...
		body: {
			required: true,
			properties: ["content", "riskStatus", "remediation"],
			requiredProperties: [],
		},
	},
	{
